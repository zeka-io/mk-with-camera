...
(function() {
  ...
  mk.controllers.WebcamInput.prototype._addMovementHandlers = function() {
    ...
    window.Detect.onForward = function() {
      f.setMove(mk.moves.types.WALK);
    };
    window.Detect.onBackward = function() {
      f.setMove(mk.moves.types.WALK_BACKWARD);
    };
    window.Detect.onSquat = function() {
      f.setMove(mk.moves.types.SQUAT);
    };
